...
public final class Constants {
	...
	public static final String VALID_XML_FILE = "Test.xml";
	public static final String INVALID_XML_FILE = "Test-invalid.xml";
	public static final String XSD_FILE = "Test.xsd";
	public static final String XSD_FILE_URI = new File(new File("").getAbsolutePath(), "Test.xsd").getAbsolutePath();
